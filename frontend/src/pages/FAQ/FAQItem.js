...
export const SecurityItem = [
        {
            question: "How can I perform Transaction, and what do I need?",
            answer: "Transaction can be performed in ____, the payer will be required for the account number of the payee."
        },
        {
            question: "What is Future-Dated Transaction?",
            answer: "Future-Dated Transaction is a money transaction that is performed in the specified time rather than instant."
        },
        {
            question: "Can I cancel a Transaction?",
            answer: "Users can only cancel the Future-Dated Transaction but not the performed Transaction."
        },
        {
            question: "Where can I check my daily transaction limit and how can I change it?",
            answer: "Users can check or change the daily transaction limit in the Profile page."
        },
        {
            question: "How much is the charge of all Transaction?",
            answer: "PiggyBank will not charge any handling free for all amounts of transactions."
        ...
        {
            question: "Where can I check my Transaction History?",
            answer: "Users can check their Transaction History in the past 30days from the Profile page."
        },
        {
            question: "Why do I recieve a Error when I make a Transaction?",
            answer: "Please make sure your account has enough balance and enter a valid account number of the payee."
        ...
        {
            question: "How can I perform cross bank or platform Transaction?",
            answer: "Users can not perform any non-local Transaction as PiggyBank does not contain any real-world currencies."
        }
